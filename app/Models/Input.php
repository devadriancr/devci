...
class Input extends Model
{
    ...
    public static function materialReceived(String $supplier, String $serial, int $item_id, int $item_quantity, ?int $container_id, int $transaction_type_id, int $location_id, ?String $no_order, ?int $delivery_production_id): Input
    {
        $input = Input::create(
            [
                'supplier' => $supplier,
