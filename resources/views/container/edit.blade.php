            ...
            <form class="grid grid-cols-12 gap-2" method="POST" action="{{ route('container.update', $container->id) }}">
                ...
                <div class="col-span-12">
                    <label class="block text-sm">
                        ...
                        <input name="code" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="A1B2C3D4XXX" value="{{ $container->code }}" autocomplete="off" />
                    </label>
                </div>
