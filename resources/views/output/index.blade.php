<x-app-layout title="Escaneo CI">
    <div class="container grid px-6 mx-auto">
        ...
        <p class="font-semibold">Escaneo Viaje: </p><p class="font-normal">{{ $travels->id }}<br></p>
            <p class="font-semibold"> Carta porte:</p> <p class="font-normal">{{ $travels->carta_porte }} <br></p>
                <p class="font-semibold">Factura: </p><p class="font-normal">{{ $travels->invoice_number }}<br></p>
                    <p class="font-semibold"> Locacion: </p><p class="font-normal">{{ $travels->location->name}}</p>
            ...
            <form method="POST" action={{ route('output.create') }}>
                ...
                <label class="block text-sm">
                    ...
                    <input name="serial"
                        ...
                        placeholder="S6030XXX1234XX" autofocus />
