<x-app-layout title="Escaneo CI">
    ...
    <form method="POST" action={{ route('DeliverySupplier.store') }}>
        @csrf
    ...
    <div class="px-4 py-3 my-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form method="POST" action={{ route('DeliverySupplier.update') }}>
            ...
            <table class="w-full whitespace-no-wrap">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-3">Tarjeta de identificación</th>
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    @foreach ($scan as $consignment)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                {{ $consignment->Identificationcard }}
                            </td>
                            <td class="px-4 py-3 text-sm">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <form method="POST" action="{{ route('DeliverySupplier.destroy') }}">
                                        @csrf
