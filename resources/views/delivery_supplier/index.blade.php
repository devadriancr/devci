<x-app-layout title="Escaneo CI">
    <div class="container grid px-6 mx-auto">
        <h2 class="mt-4 mb-2 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Entrega de Material Proveedor
        </h2>

        <form method="POST" action="{{ route('DeliverySupplier.create') }}">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        ...
                                        @if ($travelss->finish != 1)
                                            <form method="POST" action={{ route('DeliverySupplier.scanqr') }}>
                                                @csrf
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        ...
                                        {{-- <form method="POST" action="{{ route('DeliverySupplier.export') }}">
                                            @csrf
                                            <input name="delivery_id" value={{ $travelss->id }} hidden>
