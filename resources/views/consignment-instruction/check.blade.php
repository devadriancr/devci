    ...
    <div class="container grid px-6 mx-auto">
        ...
        <div class="flex flew-row justify-end mb-2">
            <div>
                ...
                <input name="data[{{ $data['serial'] }}][container]" value="{{ $data['container'] }}" hidden>
                <input name="data[{{ $data['serial'] }}][invoice]" value="{{ $data['invoice'] }}" hidden>
                <input name="data[{{ $data['serial'] }}][serial]" value="{{ $data['serial'] }}" hidden>
                <input name="data[{{ $data['serial'] }}][part_no]" value="{{ $data['part_no'] }}" hidden>
                <input name="data[{{ $data['serial'] }}][part_qty]" value="{{ $data['part_qty'] }}" hidden>
                <input name="data[{{ $data['serial'] }}][arrival_date]" value="{{ $data['arrival_date'] }}" hidden>
                <input name="data[{{ $data['serial'] }}][arrival_time]" value="{{ $data['arrival_time'] }}" hidden>
                @endforeach
