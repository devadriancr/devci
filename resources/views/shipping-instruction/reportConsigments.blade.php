<x-app-layout title="Reporte de Consigna">
    <div class="container grid px-6 mx-auto">
        ...
        <form action="{{ route('shipping-instruction.download-consignments') }}" method="post">
            @csrf
            <div class="grid grid-cols-2 gap-4 px-4 py-3 mb-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <div class="text-xs mt-1">
                        <label class="flex items-center dark:text-gray-400">
                            <input type="checkbox" value="{{ $location->id }}" name="locations[]" class="text-purple-600 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" />
                            <span class="ml-2">
