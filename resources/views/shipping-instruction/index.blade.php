        ...
        <div class="flex gap-2 px-4 py-3 mt-2 mb-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <form method="POST" action="{{ route('shipping-instruction.store') }}" enctype="multipart/form-data">
                    ...
                    <label class="block text-sm">
                        <div class="relative text-gray-500 focus-within:text-purple-600">
                            <input type="file" name="import_file" accept=".csv, .xlsx" class="block w-full pr-20 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Jane Doe" />
            ...
            <div class="flex-auto">
                <div class="flex justify-end">
                    <a href="{{ route('input.item-report') }}" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="ml-4 text-xs">Reporte No. Parte</span>
                    </a>
                </div>
            </div>
            <div class="flex-auto">
                <div class="flex justify-end">
                    <a href="{{ route('shipping-instruction.report-consignments') }}" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        ...
                        <span class="ml-4 text-xs">Reporte MC/MH</span>
                    </a>
                </div>
            </div>
            <div class="flex-auto">
                <div class="flex justify-end">
                    <a href="{{ route('shipping-instruction.report-si') }}" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        ...
                        <span class="ml-4 text-xs">Reporte MY</span>
                    </a>
                </div>
            </div>
        </div>
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            ...
                            <th class="px-4 py-3">Cantidad Parte</th>
