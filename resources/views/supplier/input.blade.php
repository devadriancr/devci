<x-app-layout title="Entradas Proveedores">
        ...
        <div class="px-4 py-3 gap-x-2 my-2 bg-white rounded-lg shadow-md dark:bg-gray-800"">
            <label class="text-sm">
                <div class="relative text-gray-500 focus-within:text-purple-600">
                    <form action="{{ route('supplier-input.index') }}" method="get">
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                {{ $supplier->received_date ?? '' }} {{ $supplier->received_time ?? '' }}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
